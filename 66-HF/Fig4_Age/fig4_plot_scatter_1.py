...
PKG_FN, SF_KEY, ML_KEY = [
  ('Age_MACRO_M5N5_k10-20_t0.6-0.9.omix', 'ucp-20-t0.8', 'ELN'),
  ('SC-30s-C31-c_M3N3_k50-200_t0.7-0.9_nested.omix', 'ucp-50-t0.9', 'ELN'),
  ('SC-30s-ABD11-c-NW_M5N5_k300-350_t0.7-0.7_nested.omix', 'ucp-300-t0.7', 'ELN'),
][2]
